...
2. Мод `Gunslinger` (19.09.22): [gunslinger_installer_160922.zip](https://mega.nz/file/sU4WSLwC#XwRn0muhv25GJYUPcShSU-nCNj7bGVpb-7CT6izHKCg)
3. Дополнительные моды в составе дистрибутива Gunslinger:
- [x] `Absolute Nature 4` (мод на растительность, настоятельно рекомендую Осенний пак)
...
3. Скопировать текстуры из пака `Stalker 2K (Tiny Little)` в папку `\gamedata\textures\` мода `Gunslinger`, созданную в п.2: `c:\games\stalker_gunslinger`.
